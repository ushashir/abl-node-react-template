        ...
        <div className="row jumbotron">
            <div className="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-10">
                <p className="lead">
                    ...
                    library environs are suitable for personal studies, and can be used to that effect upon registration. 
                </p>
                <p className="lead"> 
                Our library hall with the capacity to accomodate up to 40 persons can be rented for 
